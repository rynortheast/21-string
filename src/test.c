...
START_TEST(S21_STRCHR) {
    ...
    ck_assert_msg(strcmp(s21_strchr("", '\0'), strchr("", '\0')) == 0, "FAILURE!");
    ck_assert_msg(strcmp(s21_strchr(msg, '\0'), strchr(msg, '\0')) == 0, "FAILURE! ");
    ck_assert_msg(strcmp(s21_strchr(msg, ','), strchr(msg, ',')) == 0, "FAILURE! ");
...
START_TEST(S21_STRCAT) {
    ...
    ck_assert_msg(strcmp(s21_strcat(msg_1, "Hello, "), strcat(msg_2, "Hello, ")) == 0, "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strcat(msg_1, "World!"), strcat(msg_2, "World!")) == 0, "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strcat(msg_1, ""), strcat(msg_2, "")) == 0, "FAILURE! Test ");
}
END_TEST
...
START_TEST(S21_STRCPY) {
    char msg_1[50] = "";
    char msg_2[50] = "";
    ck_assert_msg(strcmp(s21_strcpy(msg_1, ""), strcpy(msg_2, "")) == 0, "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strcpy(msg_1, "TEST?"), strcpy(msg_2, "TEST?")) == 0, "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strcpy(msg_1, "HAhaHA"), strcpy(msg_2, "HAhaHA")) == 0, "FAILURE! Test ");
...
START_TEST(S21_STRNCPY) {
    char msg_1[50] = "";
    char msg_2[50] = "";
    ck_assert_msg(strcmp(s21_strncpy(msg_1, "", 1), strncpy(msg_2, "", 1)) == 0, "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strncpy(msg_1, "TEST?", 6), strncpy(msg_2, "TEST?", 6)) == 0, "FAIL");
    ck_assert_msg(strcmp(s21_strncpy(msg_1, "HAhaHA", 8), strncpy(msg_2, "HAhaHA", 8)) == 0, "FAI");
    ck_assert_msg(strcmp(s21_strncpy(msg_1, "", 2), strncpy(msg_2, "", 2)) == 0, "FAILURE! Test ");
}
END_TEST
...
START_TEST(S21_STRSPN) {
    ...
    ck_assert_msg(s21_strspn("", "TEST24") == strspn("" , "TEST24"), "FAILURE! Test \"TEST24\" fai");
    ck_assert_msg(s21_strspn("test was success!", "TEST24") == strspn("test was success!" , "TEST24"), "FAI");
    ck_assert_msg(s21_strspn("test was success!", "test24") == strspn("test was success!" , "test24"), "FAI");
    ck_assert_msg(s21_strspn("test was success!", "") == strspn("test was success!" , ""), "FAILURE! Test ");
}
END_TEST

START_TEST(S21_STRCSPN) {
    ck_assert_msg(s21_strcspn("", "") == strcspn("" , ""), "FAILURE! Test \"\" in \"\" ");
    ck_assert_msg(s21_strcspn("", "TEST24") == strcspn("" , "TEST24"), "FAILURE! Test ");
    ck_assert_msg(s21_strcspn("test was suc", "TEST24") == strcspn("test was suc" , "TEST24"), "FAI");
    ck_assert_msg(s21_strcspn("test was suc", "test24") == strcspn("test was suc" , "test24"), "F");
    ck_assert_msg(s21_strcspn("test was success!", "") == strcspn("test was success!" , ""), "FAILURE! ");
}
END_TEST
...
START_TEST(S21_STRPBRK) {
    ...
    ck_assert_msg(s21_strpbrk("this is", "") == strpbrk("this is", ""), "FAILURE! Test");
    ck_assert_msg(s21_strpbrk("this is", "dplf") == strpbrk("this is", "dplf"), "Fail");
}
END_TEST

START_TEST(S21_STRRCHR) {
    char msg[50] = "Hello, World!";
    ck_assert_msg(strcmp(s21_strrchr("", '\0'), strrchr("", '\0')) == 0, "FAILURE! ");
    ck_assert_msg(strcmp(s21_strrchr(msg, '\0'), strrchr(msg, '\0')) == 0, "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strrchr(msg, ','), strrchr(msg, ',')) == 0, "FAILURE! Test ");
    ck_assert_msg(s21_strrchr(msg, 'h') == strrchr(msg, 'h'), "FAILURE! Test ");
    ck_assert_msg(strcmp(s21_strchr(msg, ' '), strchr(msg, ' ')) == 0, "FAILURE! Test ");
}
END_TEST

START_TEST(S21_STRSTR) {
    ck_assert_msg(strcmp(s21_strstr("abc", ""), strstr("abc", "")) == 0, "FAILURE! ");
    ck_assert_msg(strcmp(s21_strstr("abc", "a"), strstr("abc", "a")) == 0, "FAILURE! ");
    ck_assert_msg(strcmp(s21_strstr("hello", "el"), strstr("hello", "el")) == 0, "FAILURE! ");
    char msg[50] = "abcdef";
    ck_assert_msg(strcmp(s21_strstr(msg, "ab"), strstr(msg, "ab")) == 0, "FAILURE! Test ");
...
START_TEST(S21_MEMCMP) {
    ...
    ck_assert_msg(s21_memcmp(a, b, 2) == result, "FAILURE! Test \"at\" in \"atb\" failed!");
    result = memcmp(b, a, 2);
    result = result > 0 ? 1 : (result == 0) ? 0 : -1;
    ck_assert_msg(s21_memcmp(b, a, 2) == result, "FAILURE! Test \"atb\" in \"at\" failed!");
}
END_TEST

START_TEST(S21_MEMCPY) {
    char dest[100];
    ck_assert_msg(memcmp(s21_memcpy(dest, "abc", 3), memcpy(dest, "abc", 3), 99) == 0, "FAILURE! Test ");
    ck_assert_msg(memcmp(s21_memcpy(dest, "aac", 1), memcpy(dest , "aac", 1), 99) == 0, "FAILURE! Test ");
    ck_assert_msg(memcmp(s21_memcpy(dest, "", 0), memcpy(dest, "", 0), 99) == 0, "FAILURE! Test \'\' ");
    ck_assert_msg(memcmp(s21_memcpy(dest, "11111111111", 10), memcpy(dest, "11111111111", 10), 99) == 0, "F");
}
END_TEST
...
START_TEST(S21_MEMMOVE) {
    ...
    ck_assert_msg(memcmp(s21_memmove(dest, "ba", 2), memmove(dest2, "ba", 2), 99) == 0 , "FAILURE!");
    ck_assert_msg(memcmp(s21_memmove(dest, dest + 2, 2), memmove(dest2, dest2 + 2, 2), 99) == 0 , "FAILURE!");
    ck_assert_msg(memcmp(s21_memmove(dest, "", 0), memmove(dest2, "", 0), 99) == 0 , "FAILURE! Test ");
}
END_TEST
...
START_TEST(S21_MEMSET) {
    char dest[100] = "abcdef";
    char dest2[100] = "abcdef";
    ck_assert_msg(memcmp(s21_memset(dest, 'a', 2), memset(dest2, 'a', 2), 99) == 0 , "FAILURE! ");
    ck_assert_msg(memcmp(s21_memset(dest, dest[2], 6), memset(dest2, dest2[2], 6), 99) == 0 , "FAILURE!");
    ck_assert_msg(memcmp(s21_memset(dest, ' ', 2), memset(dest2, ' ', 2), 99) == 0 , "FAILURE! Test  ");
}
END_TEST
...
START_TEST(S21_SPRINTF) {
    ...
    sprintf(MESSAGE_1, "%-15c|%-15d|%-15i|%-15e|%-15E|%-15f|%-15g|%-15G|%-15o%-15s%-15u%-15x%-15X%-30p",
        TEST_c, TEST_d, TEST_i, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
    ...
    sprintf(MESSAGE_1, "|%c|%015d|%015i|%015e|%015E|%015f|%015g|%015G|%015o|%s|%015u|%015x|%015X|%p|",
        TEST_c, TEST_d, TEST_i, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X, TEST_p);
    s21_sprintf(MESSAGE_2, "|%c|%015d|%015i|%015e|%015E|%015f|%015g|%015G|%015o|%s|%015u|%015x|%015X|%p|",
        TEST_c, TEST_d, TEST_i, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X, TEST_p);
    ...
    int TEST_accuracy = 2;
    sprintf(MESSAGE_1, "|%c|%.2d|%.2i|%.2e|%.2E|%.2f|%.2g|%.2G|%.2o|%.2s|%.2u|%.2x|%.2X|%p|%n|%%|",
        TEST_c, TEST_d, TEST_i, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X, TEST_p, &TEST_n_1);
    s21_sprintf(MESSAGE_2, "|%c|%.2d|%.2i|%.*e|%.2E|%.2f|%.2g|%.2G|%.2o|%.2s|%.2u|%.2x|%.2X|%p|%n|%%|",
        TEST_c, TEST_d, TEST_i, TEST_accuracy, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X, TEST_p, &TEST_n_2);
    ck_assert_msg(strcmp(MESSAGE_1, MESSAGE_2) == 0, "TEST #8.1 - FAILED!");
    ck_assert_msg(TEST_n_1 == TEST_n_2, "TEST #8.2 - FAILED!");

    sprintf(MESSAGE_1, "|%c|%.15d|%.15i|%.15e|%.15E|%.15f|%.15g|%.15G|%.15o|%.15s|%.15u|%.15x|%.15X",
        TEST_c, TEST_d, TEST_i, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X);
    s21_sprintf(MESSAGE_2, "|%c|%.15d|%.15i|%.15e|%.15E|%.15f|%.15g|%.15G|%.15o|%.15s|%.15u|%.15x|%.15X",
        TEST_c, TEST_d, TEST_i, TEST_e, TEST_E, TEST_f, TEST_g, TEST_G, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X);
    ...
    sprintf(MESSAGE_1, "|%c|%d|%i|%Le|%LE|%Lf|%Lg|%LG|%o|%s|%u|%x|%X|%p|%n|%%|",
        TEST_c, TEST_d, TEST_i, TEST_ee, TEST_EE, TEST_ff, TEST_gg, TEST_GG, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X, TEST_p, &TEST_n_1);
    s21_sprintf(MESSAGE_2, "|%c|%d|%i|%Le|%LE|%Lf|%Lg|%LG|%o|%s|%u|%x|%X|%p|%n|%%|",
        TEST_c, TEST_d, TEST_i, TEST_ee, TEST_EE, TEST_ff, TEST_gg, TEST_GG, TEST_o,
        TEST_s, TEST_u, TEST_x, TEST_X, TEST_p, &TEST_n_2);
...
START_TEST(S21_SSCANF) {
    ...
    s21_sscanf("1 2 -123232.001 .995123 999.99.1", "%*E %*G %g %le %Lf", &fx, &lfx, &llfx);
    sscanf("1 2 -123232.001 .995123 999.99.1", "%*E %*G %g %le %Lf", &fx1, &lfx1, &llfx1);
